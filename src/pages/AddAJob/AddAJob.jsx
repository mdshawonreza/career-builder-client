...
const AddAJob = () => {
    ...
    const handleAddAJob = event => {
        ...
        const newJob = { jobTitle, userName, jobCategory, salaryRange, jobDescription, jobPostingDate,applicationDeadline,jobApplicantsNumber ,photo ,uploadPersonEmail:user.email};
